export default function SocialMediaLinks() {
    ...
    return (
        <div className="flex mt-4 space-x-6 sm:justify-start md:mt-0 gap-5 flex-wrap mb-4">
            {socialMediaLinks.links.map((media, key) => (
                <a
                    key={key}
                    href={media.href}
                ...
                >
                    <svg
                        ...
                        aria-hidden="true"
                    >
                        <path fillRule="evenodd" d={media.svg} clipRule="evenodd"></path>
                    </svg>
